...
- **本科生**
  - 学生姓名 (时间) - 研究方向或项目描述  
    ![学生姓名](images/student1.jpg) <!-- 替换为实际图片路径 -->
  - 学生姓名 (时间) - 研究方向或项目描述  
    <img src="images/student2.jpg" alt="学生姓名" width="200"/> <!-- 用 HTML 控制大小 -->

- **硕士生**
  - 学生姓名 (时间) - 研究方向或项目描述  
    ![学生姓名](images/student3.jpg) <!-- 替换为实际图片路径 -->
  - 学生姓名 (时间) - 研究方向或项目描述  
    <img src="images/student4.jpg" alt="学生姓名" width="200"/>

- **博士生**
  - 学生姓名 (时间) - 研究方向或项目描述  
    ![学生姓名](images/student5.jpg) <!-- 替换为实际图片路径 -->
  - 学生姓名 (时间) - 研究方向或项目描述  
    <img src="images/student6.jpg" alt="学生姓名" width="200"/>
